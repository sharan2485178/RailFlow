...
public class AuthServiceImpl implements AuthService {
    ...
    public String forgotPassword(ForgotPasswordRequest req) {
        ...
        passwordResetTokens.put(token, req.getEmail());
        return token;
    }
 
    public void resetPassword(ResetPasswordRequest req) {
        String email = passwordResetTokens.get(req.getToken());
        if (email == null)
        ...
        passwordResetTokens.remove(req.getToken());
        auditService.log("RESET_PASSWORD", "User", user.getId().toString(), email,
